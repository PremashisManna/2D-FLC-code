...
while I < TrialNumFor_RegulatorConst
    ...
    while K < TrialNumFor_MinimizeEstQ
        ...
        [estimates, model] = TK_FitF_1DMEM_01(...
            Var1, Fix1orNot0orAbs2, Var3, ...
            Result_Mat_1DFDC_t, In_Mat_1DFDC, In_Mat_1DFDC_cor, ...
            Tau, In_ExpCurve, mi) ;
        
        [Result_Mat_M_Model, Result_Mat_A, Var_EstQ, Var_Kai2, Var_EntropyS] = TK_FitF_Reproduct1DFDC(...
            estimates, Var1, Fix1orNot0orAbs2, Var3, ...
            Result_Mat_1DFDC_t, In_Mat_1DFDC, In_Mat_1DFDC_cor, ...
            Tau, In_ExpCurve, mi) ;
...
[Result_Mat_M_Model_lin, Result_Mat_A, Var_EstQ] = TK_FitF_Reproduct1DFDC(...
    estimates, Var1, Fix1orNot0orAbs2, Var3, ...
    Mat_1DFDC_lint, Mat_1DFDC_lin, Mat_1DFDC_cor_lin, ...
    Tau, ExpCurve_Binned_lin, mi) ;

[Result_Mat_M_Model_log, Result_Mat_A, Var_EstQ] = TK_FitF_Reproduct1DFDC(...
    estimates, Var1, Fix1orNot0orAbs2, Var3, ...
    Mat_1DFDC_logt, Mat_1DFDC_log, Mat_1DFDC_cor_log, ...
